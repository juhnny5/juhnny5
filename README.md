...
- [cloudducoeur/DevoxxFR2025](https://github.com/cloudducoeur/DevoxxFR2025) - Comment nous avons transformé les Restos du Coeur en Cloud Provider (4 weeks ago)
...
- [Infisical/infisical](https://github.com/Infisical/infisical) ([infisical/v0.129.1-postgres](https://github.com/Infisical/infisical/releases/tag/infisical/v0.129.1-postgres), 4 days ago) - Infisical is the open-source platform for secrets management, internal PKI, and SSH access.
...
- [alexbakker/alertmanager-ntfy](https://github.com/alexbakker/alertmanager-ntfy) - Service that forwards Prometheus Alertmanager notifications to https://ntfy.sh (3 months ago)
